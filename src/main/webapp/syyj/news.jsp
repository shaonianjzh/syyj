...
<head>
    ...
    <script>
        $(function () {
            $.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/news/findNews?page=1&limit=10",
                success: function (res) {
                    for (let i = 0; i < res.data.length; i++) {
                        $("#news").append(" <div class='col-md-4'>"
                            + "<img class='new-image' src= '${pageContext.request.contextPath}/layuimini-2/images/news/"+ res.data[i].image + "'/>"
                            + "</div>"
                            + "<div class='col-md-8' style='margin-top: 30px; border-bottom:solid 2px #c2c2c2'>"
                            + "<div style='margin-left: 50px;margin-bottom: 80px ;overflow: hidden'>"
                            + "<p style='font-size: 20px;'>" + res.data[i].title + "</p>"
                            + "<p class='content'>" + res.data[i].content + "</p>"
                            + "<p style='color: #9a2926;font-size: 18px'>" + res.data[i].time + "</p>"
                            + "</div>"
                            + "</div>");
                    }
                }
...
<div class="container">
    <div class="row" style="margin-bottom: 30px">
        ...
        <div class="col-12" style="text-align: center;">关注实时新闻 / 了解企业资讯</div>
    </div>
</div>
<div class="container">
    <div id="news" class="row" style="margin-left: 80px;margin-right: 80px;margin-bottom: 30px">
<%--        <div class="col-md-4">--%>
<%--            <img class="new-image" src="${pageContext.request.contextPath}/layuimini-2/images/news/news.jpg">--%>
<%--        </div>--%>
<%--        <div class="col-md-8" style="margin-top: 30px; border-bottom:solid 2px #c2c2c2">--%>
<%--            <div style="margin-left: 50px;margin-bottom: 80px ;overflow: hidden">--%>
