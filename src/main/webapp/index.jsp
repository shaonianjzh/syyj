...
<head>
    ...
    <link rel="icon" href="layuimini-2/images/favicon.ico">
    <link rel="stylesheet" href="layuimini-2/lib/layui-v2.6.3/css/layui.css" media="all">
    <link rel="stylesheet" href="layuimini-2/css/layuimini.css?v=2.0.4.2" media="all">
    <link rel="stylesheet" href="layuimini-2/css/themes/default.css" media="all">
    <link rel="stylesheet" href="layuimini-2/lib/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
    <!--[if lt IE 9]>
