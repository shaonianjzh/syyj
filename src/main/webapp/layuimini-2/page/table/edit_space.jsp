...
<form id="culture-form" class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label required">空间</label>
        <div class="layui-input-block">
            <input type="text" id="type" name="type" lay-verify="required" lay-reqtext="空间不能为空" placeholder="请输入种类"
                   value="${name}"
                   class="layui-input">
        </div>
    </div>
...
<script>
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/product/editSpace",
