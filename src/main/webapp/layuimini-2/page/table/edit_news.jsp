...
<form id="culture-form" class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <div>
                <img id="image" src="${pageContext.request.contextPath}//layuimini-2/images/news/${news.image}" style="width: 240px;height: 300px">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form', 'upload', 'jquery','layedit'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/news/editNews",
                data:{
                    id:data.field.id,
